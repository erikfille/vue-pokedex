    ...
    <GenericModal :showModal="pokemonDetails.id">
      <template #img>
        <div class="imageContainer">
          <img
            ...
            src="@/assets/images/modal-detail-character-background.jpg"
          />
      ...
      <template #details>
        <div class="detailsContainer">
          ...
          <div class="element">
            <h3>Types:</h3>
            <span>{{ pokemonDetails.types }}</span>
          </div>
        </div>
      </template>
      <template #footer>
        ...
        <img
          v-if="pokemonDetails.isFavorite"
          src="@/assets/icons/favorite-selected.svg"
          alt="isFavorite"
        ...
        <img
          class="favoriteIcon"
          v-else
          src="@/assets/icons/favorite-unselected.svg"
          alt="isFavorite"
          @click="setFavoriteHandler"
        />
      </template>
...
export default {
  ...
  methods: {
    ...
    async setFavoriteHandler() {
      this.pokemonDetails.isFavorite
        ? await this.removeFavorite(this.pokemonDetails.id)
        : await this.addFavorite(this.pokemonDetails.id)
    },
    getButtonStyles() {
      let styles
